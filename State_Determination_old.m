...
function [Shear_Stress_n_1, Shear_Strain_n_1, Shear_Plastic_Strain_n_1, Element_G_n_1, Broken_Elements_n_1, Softening_Elements_n_1, Colour_n_1, Shear_sigma_yeild_n_1] = State_Determination_old(Shear_Stress, Shear_Strain, Shear_Plastic_Strain, Shear_Delta_Strain, Element_G, Broken_Elements, Softening_Elements, Shear_sigma_yeild,Colour,p)
...
%         Shear_Delta_plastic_strain(I3,1)=fr(I3)/(p.G + p.H_2);
        ...
        Shear_Stress_n_1(I3,1) = Shear_Stress(I3,1) + p.G_2*(Shear_Delta_Strain(I3,1));
        
        Shear_Plastic_Strain_n_1(I3,1) = Shear_Strain_n_1(I3,1) - abs(Shear_Stress_n_1(I3,1))/p.G; 
        Shear_Plastic_Strain_n_1(Shear_Plastic_Strain_n_1<0)=0;
